import { getStaticCountries } from '@/lib';
    ...
    <main className="mx-auto mt-6 max-w-7xl px-4">
      <SearchProvider>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-6 rounded bg-bg-secondary px-6 py-4">
            <svg
        ...
        <ul className="mt-8 grid grid-cols-[min(20rem,100%)] gap-10">
